...
class OldZoomer extends StatelessWidget {
  /// --------------------------------------------------------------------------
  const OldZoomer({
    required this.child,
    this.onTap,
...
class _OldZoomableChild extends StatefulWidget {
  /// --------------------------------------------------------------------------
  const _OldZoomableChild({
    required this.child,
    required this.onTap,
  ...
  /// --------------------------------------------------------------------------
  @override
  _OldZoomableChildState createState() => _OldZoomableChildState();
  /// --------------------------------------------------------------------------
}

class _OldZoomableChildState extends State<_OldZoomableChild> with TickerProviderStateMixin {
  // -----------------------------------------------------------------------------
  ...
  Future<void> _animateToMatrix(Matrix4 matrixTo) async {
    ...
    await OldZoomer.animateToMatrix(
      matrixTo: matrixTo,
      mounted: mounted,
