...
class DirectZoomer extends StatelessWidget {
  /// --------------------------------------------------------------------------
  const DirectZoomer({
    required this.child,
    this.onTap,
...
class _DirectZoomableChild extends StatefulWidget {
  /// --------------------------------------------------------------------------
  const _DirectZoomableChild({
    required this.child,
    required this.onTap,
  ...
  /// --------------------------------------------------------------------------
  @override
  _DirectZoomableChildState createState() => _DirectZoomableChildState();
  /// --------------------------------------------------------------------------
}

class _DirectZoomableChildState extends State<_DirectZoomableChild> with TickerProviderStateMixin {
  // -----------------------------------------------------------------------------
  ...
  Future<void> _animateToMatrix(Matrix4 matrixTo) async {
    ...
    await DirectZoomer.animateToMatrix(
      matrixTo: matrixTo,
      mounted: mounted,
