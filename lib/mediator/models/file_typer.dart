...
class FileTyper {
  ...
  // --------------------
  /// AI GENERATED
  static String? cipherType(FileType? fileType) {
  ...
  // --------------------
  /// AI GENERATED
  static FileType? decipherType(String? fileType) {
  ...
  static bool checkFileIsImage(FileType? fileType){

    switch (fileType){
      case FileType.png       : return true; /// <----- pic
      case FileType.jpeg      : return true; /// <----- pic
      case FileType.gif       : return false; // <-video
      case FileType.bmp       : return true; /// <----- pic
      case FileType.webp      : return false; // <-video
      case FileType.mp3       : return false; // <-audio
      case FileType.wav       : return false; // <-audio
      case FileType.ogg       : return false; // <-video
      case FileType.mp4       : return false; // <-video
      case FileType.mpeg      : return false; // <-video
      case FileType.quicktime : return false; // <-x
      case FileType.pdf       : return false; // <-PDF
      case FileType.doc       : return false; // <-word
      case FileType.docx      : return false; // <-word
      case FileType.xls       : return false; // <-excel
      case FileType.xlsx      : return false; // <-excel
      case FileType.ppt       : return false; // <-power point
      case FileType.pptx      : return false; // <-power point
      case FileType.plainText : return false; // <-text
      case FileType.unknown   : return false; // <-x
  ...
  // --------------------
  /// TESTED : WORKS PERFECT
  static bool checkFileIsVideo(FileType? fileType){

    switch (fileType){
      case FileType.png       : return false; // <- pic
      case FileType.jpeg      : return false; // <- pic
      case FileType.gif       : return true; /// <----- video
      case FileType.bmp       : return false; // <- pic
      case FileType.webp      : return true; /// <----- video
      case FileType.mp3       : return false; // <-audio
      case FileType.wav       : return false; // <-audio
      case FileType.ogg       : return true; /// <----- video
      case FileType.mp4       : return true; /// <----- video
      case FileType.mpeg      : return true; /// <----- video
      case FileType.quicktime : return false; // <-x
      case FileType.pdf       : return false; // <-PDF
      case FileType.doc       : return false; // <-word
      case FileType.docx      : return false; // <-word
  ...
  // --------------------
  /// TESTED : WORKS PERFECT
  static bool checkFileIsAudio(FileType? fileType){
    ...
    switch (fileType){
      ...
      case FileType.bmp       : return false; // <- pic
      case FileType.webp      : return false; // <-video
      case FileType.mp3       : return true; /// <----- audio
      case FileType.wav       : return true; /// <----- audio
      case FileType.ogg       : return false; // <-video
      case FileType.mp4       : return false; // <-video
      case FileType.mpeg      : return false; // <-video
      case FileType.quicktime : return false; // <-x
